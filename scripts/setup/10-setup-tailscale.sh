#!/bin/bash
# ===========================================
# Step 11: Configure Tailscale (mesh VPN)
# ===========================================
...
print_header "Step 11: Configuring Tailscale (mesh VPN)"
...
if [[ -n "$TS_ADVERTISE_ROUTES" ]]; then
    ...
    echo "   • DNS → Nameservers → Custom: домен 1218217.xyz → ${TS_IP} (домашний AdGuard, split-DNS)"
